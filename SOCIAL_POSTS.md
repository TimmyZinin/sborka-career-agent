# Посты для соцсетей — AI Career Agent Lead Magnet

> Для ревью Тимом перед публикацией.

## Сводная таблица

| # | Платформа | Аккаунт | Язык | Ссылка в посте | Лимит | Статус |
|---|----------|---------|------|---------------|-------|--------|
...
## 1. Telegram канал СБОРКА (RU)

```
Собрал бесплатный инструмент для поиска работы.

Это промпт, который ты копируешь, вставляешь в ChatGPT или Claude, заполняешь свой профиль. Через 2 минуты получаешь персональный карьерный план: какие роли тебе подходят, где искать, что писать в холодных сообщениях, и 5 конкретных действий на сегодня.

Промпт работает для любой роли: разработчик, продакт, дизайнер, маркетолог, аналитик. Не нужен опыт с AI, не нужно уметь кодить.
...
Записаться: https://t.me/Sborka_work_bot?start=webinar3_aiagent_tg
```

---

## 2. Telegram канал @timofeyzinin (RU)

```
Сделал штуку, которая экономит часы на поиске работы.

Взял опыт работы с AI-агентами и карьерным консалтингом, собрал в один промпт. Копируешь, вставляешь в ChatGPT или Claude, заполняешь профиль. За 2 минуты получаешь: 3-5 целевых ролей с оценкой fit, список площадок, шаблоны аутрича и план на сегодня.
...
Большинство кандидатов проигрывают не из-за нехватки навыков. Они проигрывают из-за позиционирования.
...
```
Собрал бесплатный промпт, который за 2 минуты создаёт персональный план поиска работы.

Как это работает: копируешь промпт со страницы, вставляешь в ChatGPT или Claude, заполняешь свой профиль. Получаешь: 3-5 целевых ролей с оценкой подходящести, конкретные площадки для поиска, шаблоны холодных сообщений, 5 действий на сегодня.
...
Записаться: https://t.me/Sborka_work_bot?start=webinar3_aiagent_vk
```

---

## 8. Bluesky — timzinin.bsky.social (EN)

```
Free prompt that creates a personalized job search plan in 2 min.

Copy → ChatGPT/Claude → fill profile → get roles, platforms, outreach templates.
...
## 9. Dev.to — @timmyzinin (EN)

> Формат: статья/пост

**Title:** I Built an AI Career Agent Architecture (+ Free Prompt That Plans Your Job Search in 2 Minutes)
...
- **R**elevance — Does it match your skills?
- **U**rgency — How urgently are they hiring?
- **C**ompensation — Money, equity, upside
- **F**it — Work style, culture, values
- **G**rowth — Market, team, product potential

Only opportunities scoring 7+ reach your Telegram.
...
Built as part of [СБОРКА](https://sborka.work), a career discipline club. We help people land offers in 30-60 days through structured systems, not hope.
...
## 10. OK.ru — Тимофей Зинин (RU)

```
Собрал бесплатный промпт для поиска работы. Копируешь, вставляешь в ChatGPT или Claude, заполняешь профиль. За 2 минуты получаешь план: какие роли подходят, где искать, что писать работодателям.
...
Предлагаю сделать скриншот hero-секции сайта sborka.work/ai-agent/ (RU для русских платформ, EN для английских). Скриншот покажет: заголовок "ПРОМПТ, КОТОРЫЙ ИЩЕТ РАБОТУ ЗА ТЕБЯ", статистику "2 мин / 5 ролей / 0₽", кнопку CTA.

Альтернативно: можно сгенерировать OG-картинку с текстом "AI Career Agent / Free Prompt / sborka.work".

---

## Примечания

1. **CTA:** Все посты ведут на вебинар через бота (разные UTM: _tg, _li, _li_kr, _fb, _vk, _ok)
2. **Tone of Voice:** Соблюдены все 20 правил. Без тире, без пафоса, начинаем с пользы.
3. **Ссылка на бота:** Есть в каждом посте.
4. **Kristina LinkedIn:** Пост от её лица, фокус на рекрутинговый опыт.
5. **Dev.to:** Полноценная статья с техническими деталями, привлечёт разработчиков.
